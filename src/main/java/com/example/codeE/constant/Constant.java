...
public class Constant {
    ...
    public static final String SEND_OTP_MAIL_TEMPLATE = """
            ...
            WisdomWorks.""";
    public static final String BRIDGED_HOST = "0.0.0.0";
