...
class CodeExerciseDiffblueTest {
     ...
     *   <li>{@link CodeExercise#setUsingAiGrading(boolean)}
     ...
     *   <li>{@link CodeExercise#isUsingAiGrading()}
     * </ul>
     */
    @Test
    void testGettersAndSetters() {
        ...
        actualCodeExercise.setUsingAiGrading(true);
        ...
        boolean actualIsUsingAiGradingResult = actualCodeExercise.isUsingAiGrading();
     ...
     * <ul>
     *   <li>
     * {@link CodeExercise#CodeExercise(String, Double, Integer, Boolean, boolean, List, Double, String, List, boolean)}
     *   <li>{@link CodeExercise#setAllowedLanguageIds(List)}
     *   <li>{@link CodeExercise#setDescription(String)}
     *   <li>{@link CodeExercise#setMemoryLimit(Integer)}
     *   <li>{@link CodeExercise#setPartial(boolean)}
    ...
    void testGettersAndSetters2() {
        ...
        CodeExercise actualCodeExercise = new CodeExercise("The characteristics of someone or something", 10.0d, 1, true,
                true, allowedLanguageIds, 10.0d, "Template", new ArrayList<>(), true);
