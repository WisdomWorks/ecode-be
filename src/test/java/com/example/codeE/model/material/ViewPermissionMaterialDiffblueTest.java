...
class ViewPermissionMaterialDiffblueTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link ViewPermissionMaterial#ViewPermissionMaterial()}
     *   <li>{@link ViewPermissionMaterial#setGroup(Group)}
     *   <li>{@link ViewPermissionMaterial#setGroupId(String)}
     *   <li>{@link ViewPermissionMaterial#setMaterial(Material)}
     *   <li>{@link ViewPermissionMaterial#setMaterialId(String)}
     *   <li>{@link ViewPermissionMaterial#getGroup()}
     *   <li>{@link ViewPermissionMaterial#getGroupId()}
     *   <li>{@link ViewPermissionMaterial#getMaterial()}
     *   <li>{@link ViewPermissionMaterial#getMaterialId()}
     * </ul>
     */
    @Test
    void testGettersAndSetters() {
        // Arrange and Act
        ViewPermissionMaterial actualViewPermissionMaterial = new ViewPermissionMaterial();
        ...
        actualViewPermissionMaterial.setGroup(group);
        actualViewPermissionMaterial.setGroupId("42");
        ...
        actualViewPermissionMaterial.setMaterial(material);
        actualViewPermissionMaterial.setMaterialId("42");
        Group actualGroup = actualViewPermissionMaterial.getGroup();
        String actualGroupId = actualViewPermissionMaterial.getGroupId();
        Material actualMaterial = actualViewPermissionMaterial.getMaterial();

        // Assert that nothing has changed
        assertEquals("42", actualGroupId);
        assertEquals("42", actualViewPermissionMaterial.getMaterialId());
    ...
    void testGettersAndSetters2() {
        ...
        // Act
        ViewPermissionMaterial actualViewPermissionMaterial = new ViewPermissionMaterial("42", "42", material, group);
        ...
        actualViewPermissionMaterial.setGroup(group2);
        actualViewPermissionMaterial.setGroupId("42");
        ...
        actualViewPermissionMaterial.setMaterial(material2);
        actualViewPermissionMaterial.setMaterialId("42");
        Group actualGroup = actualViewPermissionMaterial.getGroup();
        String actualGroupId = actualViewPermissionMaterial.getGroupId();
        Material actualMaterial = actualViewPermissionMaterial.getMaterial();
        ...
        assertSame(material2, actualMaterial);
    }
}
