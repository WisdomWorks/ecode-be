...
class CreateCodeExerciseRequestDiffblueTest {
     ...
     *   <li>{@link CreateCodeExerciseRequest#setUsingAiGrading(boolean)}
     ...
     *   <li>{@link CreateCodeExerciseRequest#isUsingAiGrading()}
     * </ul>
     */
    @Test
    void testGettersAndSetters() {
        ...
        actualCreateCodeExerciseRequest.setUsingAiGrading(true);
        ...
        boolean actualIsUsingAiGradingResult = actualCreateCodeExerciseRequest.isUsingAiGrading();
     ...
     * <ul>
     *   <li>
     * {@link CreateCodeExerciseRequest#CreateCodeExerciseRequest(String, String, String, Date, Date, int, int, String, List, Double, List, String, boolean)}
     *   <li>{@link CreateCodeExerciseRequest#setAllowedLanguageIds(List)}
     *   <li>{@link CreateCodeExerciseRequest#setDescription(String)}
     *   <li>{@link CreateCodeExerciseRequest#setDurationTime(int)}
     *   <li>{@link CreateCodeExerciseRequest#setEndTime(Date)}
