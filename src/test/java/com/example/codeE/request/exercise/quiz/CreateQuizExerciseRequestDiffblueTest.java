...
class CreateQuizExerciseRequestDiffblueTest {
     ...
     *   <li>{@link CreateQuizExerciseRequest#setExerciseDescription(String)}
     ...
     *   <li>{@link CreateQuizExerciseRequest#getExerciseDescription()}
    ...
    void testGettersAndSetters() {
        ...
        actualCreateQuizExerciseRequest.setExerciseDescription("Exercise Description");
        ...
        String actualExerciseDescription = actualCreateQuizExerciseRequest.getExerciseDescription();
    ...
    void testGettersAndSetters2() {
        ...
        CreateQuizExerciseRequest actualCreateQuizExerciseRequest = new CreateQuizExerciseRequest("42", "Exercise Name",
                "Key", startTime, endTime, 1, 1, "Exercise Description", questions);
        actualCreateQuizExerciseRequest.setDurationTime(1);
