...
class FileSubmissionsResponseDiffblueTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link FileSubmissionsResponse#FileSubmissionsResponse()}
     *   <li>{@link FileSubmissionsResponse#setExercise(Exercise)}
     *   <li>{@link FileSubmissionsResponse#setStudent(User)}
     *   <li>{@link FileSubmissionsResponse#setSubmissions(FileSubmission)}
     *   <li>{@link FileSubmissionsResponse#getExercise()}
     *   <li>{@link FileSubmissionsResponse#getStudent()}
     *   <li>{@link FileSubmissionsResponse#getSubmissions()}
     * </ul>
     */
    @Test
    void testGettersAndSetters() {
        // Arrange and Act
        FileSubmissionsResponse actualFileSubmissionsResponse = new FileSubmissionsResponse();
        ...
        actualFileSubmissionsResponse.setExercise(exercise);
        ...
        actualFileSubmissionsResponse.setStudent(student);
        FileSubmission submissions = new FileSubmission();
        submissions.setDateGrade("2020-03-01");
        submissions.setDateSubmit("2020-03-01");
        submissions.setExerciseId("42");
        submissions.setFileUrl("https://example.org/example");
        ...
        actualFileSubmissionsResponse.setSubmissions(submissions);
        Exercise actualExercise = actualFileSubmissionsResponse.getExercise();
        User actualStudent = actualFileSubmissionsResponse.getStudent();

        // Assert that nothing has changed
        assertSame(exercise, actualExercise);
        assertSame(submissions, actualFileSubmissionsResponse.getSubmissions());
    ...
    void testGettersAndSetters2() {
        ...
        // Act
        FileSubmissionsResponse actualFileSubmissionsResponse = new FileSubmissionsResponse(submissions, student, exercise);
        ...
        actualFileSubmissionsResponse.setExercise(exercise2);
        ...
        actualFileSubmissionsResponse.setStudent(student2);
        FileSubmission submissions2 = new FileSubmission();
        submissions2.setDateGrade("2020-03-01");
        submissions2.setDateSubmit("2020-03-01");
        submissions2.setExerciseId("42");
        submissions2.setFileUrl("https://example.org/example");
        ...
        actualFileSubmissionsResponse.setSubmissions(submissions2);
        Exercise actualExercise = actualFileSubmissionsResponse.getExercise();
        User actualStudent = actualFileSubmissionsResponse.getStudent();

        // Assert that nothing has changed
        assertSame(exercise2, actualExercise);
        assertSame(submissions2, actualFileSubmissionsResponse.getSubmissions());
