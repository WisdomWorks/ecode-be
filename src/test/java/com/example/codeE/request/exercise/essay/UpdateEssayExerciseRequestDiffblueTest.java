...
class UpdateEssayExerciseRequestDiffblueTest {
     ...
     *   <li>{@link UpdateEssayExerciseRequest#setUsingAiGrading(boolean)}
     ...
     *   <li>{@link UpdateEssayExerciseRequest#isUsingAiGrading()}
     * </ul>
     */
    @Test
    void testGettersAndSetters() {
        ...
        actualUpdateEssayExerciseRequest.setUsingAiGrading(true);
        ...
        String actualTopicId = actualUpdateEssayExerciseRequest.getTopicId();
        ...
        assertTrue(actualUpdateEssayExerciseRequest.isUsingAiGrading());
     ...
     * <ul>
     *   <li>
     * {@link UpdateEssayExerciseRequest#UpdateEssayExerciseRequest(String, String, String, String, Date, Date, int, int, String, String, boolean)}
     *   <li>{@link UpdateEssayExerciseRequest#setDurationTime(int)}
     *   <li>{@link UpdateEssayExerciseRequest#setEndTime(Date)}
     *   <li>{@link UpdateEssayExerciseRequest#setExerciseDescription(String)}
     *   <li>{@link UpdateEssayExerciseRequest#setExerciseId(String)}
