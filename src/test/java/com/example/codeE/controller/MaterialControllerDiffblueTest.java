...
class MaterialControllerDiffblueTest {
    ...
    void testAddViewPermission2() throws Exception {
        ...
        // Act
        ResultActions actualPerformResult = MockMvcBuilders.standaloneSetup(materialController)
                .build()
                .perform(requestBuilder);
        ...
        actualPerformResult.andExpect(MockMvcResultMatchers.status().is(500))
                .andExpect(MockMvcResultMatchers.content().contentType("application/json"))
                .andExpect(
                        MockMvcResultMatchers.content().string("{\"massage\":\"Can not grant permission for this material\"}"));
    }
