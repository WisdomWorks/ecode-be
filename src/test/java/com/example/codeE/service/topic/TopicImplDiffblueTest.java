...
class TopicImplDiffblueTest {
    ...
    void testUpdateTopic() {
        ...
        Topic actualUpdateTopicResult = topicImpl
                .updateTopic(new UpdateTopicRequest("42", "Topic Name", "The characteristics of someone or something"));
    ...
    void testRemoveViewPermission6() {
        ...
        // Assert
        verify(viewPermissionTopicRepository, atLeast(1)).removeViewPermission(eq("42"), Mockito.<String>any());
        verify(groupRepository, atLeast(1)).findById(Mockito.<String>any());
        verify(topicRepository).findById(eq("42"));
        assertTrue(actualRemoveViewPermissionResult);
    }
