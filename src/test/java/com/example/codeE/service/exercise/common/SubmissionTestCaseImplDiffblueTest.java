...
class SubmissionTestCaseImplDiffblueTest {
    ...
    void testGetMaxPosition3() {
        ...
        verify(submissionTestCase).setMemory(eq(10.0d));
        verify(submissionTestCase).setOutput(eq("Output"));
        verify(submissionTestCase).setPoints(eq(10.0d));
        verify(submissionTestCase).setStatus(eq("Status"));
        verify(submissionTestCase).setSubmissionId(eq("42"));
        verify(submissionTestCase).setTestCaseId(eq(1));
        verify(submissionTestCase).setTime(eq(10.0d));
        verify(submissionTestCase).setTotal(eq(10.0d));
