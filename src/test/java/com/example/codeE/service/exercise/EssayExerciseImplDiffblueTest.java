...
class EssayExerciseImplDiffblueTest {
    ...
    void testGetEssayExerciseDetail() {
        ...
        assertEquals("Exercise Description", actualEssayExerciseDetail.getExerciseDescription());
    ...
    void testGetEssayExerciseDetail2() {
        ...
        when(essayExercise.getExerciseDescription()).thenReturn("Exercise Description");
        ...
        verify(essayExercise).getExerciseDescription();
